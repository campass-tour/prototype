...
export default function ARUnsupportedPrompt({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center bg-[var(--color-surface)] rounded-[16px] border border-[var(--color-primary)]/10 shadow-[var(--shadow-card)] mx-6 text-[var(--color-text-main)] max-w-sm">
