  ...
  return (
    <div className="bg-[var(--color-surface)] rounded-[var(--radius-card)] overflow-hidden shadow-[var(--shadow-card)] w-full border border-[var(--border)]">
      <div className="flex flex-col">
        {/* About Item */}
        <button className="w-full flex items-center justify-between px-6 py-5 border-b border-gray-100 hover:bg-gray-50 transition-colors group">
          <div className="flex items-center gap-4 text-[var(--color-text-main)]">
            <div className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 group-hover:bg-gray-200 transition-colors">
              <Info size={18} />
            </div>
